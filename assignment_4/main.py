...
def align(image_to_align, reference_image, max_features, good_match_percent):
    MIN_MATCH_COUNT = 10
...
def main():
    img1 = cv2.imread("reference_img.png")
    img2 = cv2.imread("align_this.jpg")
    detect_corners(img1)
    align(img2, img1, 10, 0.7)
